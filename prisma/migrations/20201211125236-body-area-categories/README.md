# Migration `20201211125236-body-area-categories`

This migration has been generated by ObserverMoment at 12/11/2020, 12:52:36 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."BodyAreaFrontBack" AS ENUM ('BACK', 'FRONT')

CREATE TYPE "public"."BodyAreaUpperLower" AS ENUM ('LOWER', 'UPPER')
```
