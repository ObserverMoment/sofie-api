# Migration `20200513182524-reset`

This migration has been generated by ObserverMoment at 5/13/2020, 6:25:24 PM.
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"followeeId" text   ,"followerId" text  NOT NULL ,"id" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "public"."_watchersToChallenges" (
...
ALTER TABLE "public"."Workout" ADD COLUMN "scope" "AccessScopeType" NOT NULL DEFAULT 'PRIVATE',
ALTER COLUMN "summary" DROP NOT NULL;

CREATE UNIQUE INDEX "_watchersToChallenges_AB_unique" ON "public"."_watchersToChallenges"("A","B")

CREATE  INDEX "_watchersToChallenges_B_index" ON "public"."_watchersToChallenges"("B")

CREATE UNIQUE INDEX "_ChallengeToWorkout_AB_unique" ON "public"."_ChallengeToWorkout"("A","B")

CREATE  INDEX "_ChallengeToWorkout_B_index" ON "public"."_ChallengeToWorkout"("B")

ALTER TABLE "public"."UserConnection" ADD FOREIGN KEY ("followerId")REFERENCES "public"."User"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."UserConnection" ADD FOREIGN KEY ("followeeId")REFERENCES "public"."User"("id") ON DELETE SET NULL  ON UPDATE CASCADE

ALTER TABLE "public"."_watchersToChallenges" ADD FOREIGN KEY ("A")REFERENCES "public"."Challenge"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."_watchersToChallenges" ADD FOREIGN KEY ("B")REFERENCES "public"."User"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."_ChallengeToWorkout" ADD FOREIGN KEY ("A")REFERENCES "public"."Challenge"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "public"."_ChallengeToWorkout" ADD FOREIGN KEY ("B")REFERENCES "public"."Workout"("id") ON DELETE CASCADE  ON UPDATE CASCADE
```
