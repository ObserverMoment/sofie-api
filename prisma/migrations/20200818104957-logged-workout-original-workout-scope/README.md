# Migration `20200818104957-logged-workout-original-workout-scope`

This migration has been generated by ObserverMoment at 8/18/2020, 11:49:57 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."Challenge" DROP COLUMN "scope",
ADD COLUMN "scope" "AccessScopeType" NOT NULL DEFAULT E'PRIVATE';

ALTER TABLE "public"."Group" DROP COLUMN "scope",
ADD COLUMN "scope" "AccessScopeType" NOT NULL DEFAULT E'PRIVATE';

ALTER TABLE "public"."Move" DROP COLUMN "scope",
ADD COLUMN "scope" "AccessScopeType" NOT NULL DEFAULT E'PRIVATE';

ALTER TABLE "public"."Workout" DROP COLUMN "scope",
ADD COLUMN "scope" "AccessScopeType" NOT NULL DEFAULT E'PRIVATE';

DROP TYPE "AccessScopeType_new"
```
